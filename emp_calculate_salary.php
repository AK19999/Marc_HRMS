...
if($row_count=mysql_fetch_array($count))
{
  ...
  if($row_emp=mysql_fetch_array($res_emp))
   ...
   //  print_r($row_sal);
     ...
     <div class="col s8 m6 offset-s2 offset-m3"5 style="background:rgba(0,0,0,0.5)">
     <h3 class="white-text">No. of Work Days : <?php echo $workday; ?>Days</h3>   
     <h3 class="white-text">Advance Salary : <?php echo $adv;  ?>.00/Rupay</h3>
         <h4 class="white-text"> Total Salary Till Now : <?php echo $workday*$paygrade-$adv; ?>.00/Rupay</h4>
</div>
</div>
